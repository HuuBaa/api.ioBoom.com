...
class Article(models.Model):
    ...
    picture=models.ImageField(null=True,upload_to='article_images',verbose_name="主图",help_text="主图")
...
class Comment(models.Model):
    author=models.ForeignKey(User,on_delete=models.CASCADE,verbose_name="评论人",help_text="评论人")
    ...
    def __str__(self):
        return '一级评论<id:%s> 文章:%s '%(self.id,self.article)
...
class Subcomment(models.Model):
    ...
    reply_to=models.ForeignKey(settings.AUTH_USER_MODEL,on_delete=models.CASCADE,related_name='sub_comments',verbose_name="回复给",help_text="回复给")
